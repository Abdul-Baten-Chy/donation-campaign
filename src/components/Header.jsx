...
const Header = () => {
    return (
        <div className="bg-[url('https://i.ibb.co/7py7rLm/bg.png')] mx-auto w-[1020px] h-[600px]">
            <div className="w-[1020px] h-[600px] bg-gray-200 opacity-95 flex flex-col justify-center items-center">
